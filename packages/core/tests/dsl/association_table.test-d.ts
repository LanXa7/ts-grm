...
import { __MakeAssociationModel } from "@/dsl/association_internal_types";
import { FilterType } from "@/dsl/table";
...
describe("AssociationTableTypeTest", () => {
    ...
    it("multiColumns", () => {
        ...
        expectTypeOf<typeof model>().toEqualTypeOf<__MakeAssociationModel<typeof ORDER, "tags">>();
